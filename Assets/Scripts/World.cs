...
public class World : MonoBehaviour
{
    ...
    void AssignBoatRoot(Transform resolvedBoatRoot)
    {
        ...
        Transform previousBoatRoot = boatRoot;

        boatRoot = resolvedBoatRoot;

        SyncBoatFollowCamera(previousBoatRoot);
    }

    void SyncBoatFollowCamera(Transform previousBoatRoot)
    {
        if (boatRoot == null)
        {
            return;
        ...
        if (followCamera.target == null || followCamera.target == previousBoatRoot)
        {
